...
if __name__ == "__main__":
    ...
    os.mkdir(f'./{min_dt}-{max_dt}')
    #transactions_df.to_parquet(f'./{min_dt}-{max_dt}/transactions.parquet')
    #customer_profiles_table.to_parquet(f'./{min_dt}-{max_dt}/customers.parquet')
    #terminal_profiles_table.to_parquet(f'./{min_dt}-{max_dt}/terminals.parquet')
    transactions_df = add_frauds(customer_profiles_table, terminal_profiles_table, transactions_df)
    transactions_df.to_csv(f'./{min_dt}-{max_dt}/transactions.csv', index=False)
    customer_profiles_table.to_csv(f'./{min_dt}-{max_dt}/customers.csv', index=False)
    terminal_profiles_table.to_csv(f'./{min_dt}-{max_dt}/terminals.csv', index=False)
