...
- провайдеры в AirFlow устанавливать только через sudo, т.к. web-интерфейс, видимо, запускается через sudo и в противном случае не подиянет новые провайдеры;
